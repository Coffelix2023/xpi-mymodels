...
interface GlimpseModule {
  open(html: string, options: GlimpseOpenOptions): GlimpseWindow;
}
...
*{box-sizing:border-box}html,body{height:100%;margin:0}body{background:var(--surface);color:var(--ink);font:13px/1.45 system-ui,-apple-system,"Segoe UI",sans-serif}input,select{font:inherit;color:inherit}.shell{height:100%;display:flex;flex-direction:column;overflow:hidden;background:var(--surface)}
 .nav{display:flex;align-items:center;gap:8px;padding:8px 20px;border-bottom:1px solid var(--rule)}.tabs{flex:1;display:flex;gap:4px;overflow-x:auto;min-width:0}.tab{border:1px solid transparent;background:transparent;color:var(--muted);border-radius:7px;padding:6px 12px;cursor:pointer;white-space:nowrap;font-size:13px;font-weight:500}.tab.active{background:var(--control);color:var(--ink);border-color:var(--rule);font-size:14px;font-weight:700}.tools{display:flex;gap:6px;align-items:center;flex-shrink:0}.tool,.btn{border:1px solid var(--rule);background:var(--control);color:var(--ink);border-radius:7px;cursor:pointer}.tool{width:28px;height:26px;font-size:11px}.segmented{display:flex;gap:2px;padding:2px;border:1px solid var(--rule);border-radius:7px;background:var(--control)}.segment{border:0;background:transparent;color:var(--muted);border-radius:5px;padding:3px 7px;cursor:pointer;font-size:11px}.segment.active{background:var(--primary);color:#fff}
 .content{flex:1;min-height:0;overflow:hidden;padding:14px 20px}form{height:100%;display:flex;flex-direction:column}.section-head{display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--rule);padding-bottom:6px;margin:6px 0 12px}.section-title{font-size:15px;font-weight:700;color:var(--ink)}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0 12px}.provider-grid{grid-template-columns:minmax(0,1fr);margin-bottom:10px}.field{margin-bottom:10px}.field label{display:block;color:var(--muted);font-size:11px;margin-bottom:4px}.field input,.field select{width:100%;padding:6px 9px;border:1px solid var(--rule);border-radius:6px;background:var(--input-bg)}
